...
def dbconnect():
    ...
    try:
        ...
        print('Data Base connection error. Description {0}'.format(err.message))
        return None, None
...
def deleteMatches():
    ...
    #db_cur.execute("ALTER SEQUENCE serial RESTART WITH 1", ())
...
def reportMatch(winner, loser):
    ...
    """
    result = commits("INSERT INTO matches (player_id, opponent_id) VALUES (%s,%s)",
                  (winner,loser,))
